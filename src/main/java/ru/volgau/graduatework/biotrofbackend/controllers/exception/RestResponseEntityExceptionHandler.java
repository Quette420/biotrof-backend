...
import ru.volgau.graduatework.biotrofbackend.exceptions.IncorrectPasswordException;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<Object> handleIncorrectPasswordException(final RuntimeException e, ServletWebRequest request) {
        log.error("IncorrectPasswordException ", e);
        final ApiError apiError = message(e, request);
        return handleExceptionInternal(e, apiError, new HttpHeaders(), HttpStatus.INTERNAL_SERVER_ERROR, request);
    }
